...
export const metadata: Metadata = {
  title: "Wallet Passport — HoodMap",
  description:
    "Paste a wallet address. Reconstructed trade history, win rate, realized P&L, and open and closed positions across every token it has touched.",
};
    ...
    <main className="relative min-h-[100svh] bg-canvas">
      ...
      <section className="mx-auto flex min-h-[calc(100svh-6rem)] max-w-2xl flex-col items-center justify-center px-5 pt-24 text-center">
        ...
        <p className="mt-4 max-w-md text-[15px] leading-relaxed text-ink-muted">
          Paste any wallet. Reconstructed trade history, win rate, realized P&amp;L, and open and
          closed positions — across every token it has touched, not just one.
        </p>
