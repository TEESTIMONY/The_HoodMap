...
export const metadata: Metadata = {
  title: "HoodMap view — HoodMap",
  description:
    "A force-directed bubble map of a token's holders — sized by share of supply, coloured by cluster, with funder-to-funded arrows showing how a cluster was seeded.",
};
    ...
    <main className="relative min-h-[100svh] bg-canvas">
      ...
      <section className="mx-auto flex min-h-[calc(100svh-6rem)] max-w-2xl flex-col items-center justify-center px-5 pt-24 text-center">
        ...
        <p className="mt-4 max-w-md text-[15px] leading-relaxed text-ink-muted">
          Paste a token contract. A force-directed bubble map of every holder — sized by share of
          supply, coloured by cluster, with funder-to-funded arrows showing how a cluster was
          seeded.
        </p>
